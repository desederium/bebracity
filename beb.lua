 ...
 local function joinsbr()
    ...
    local function Kill()
        ...
        local AutoKill = true
			...
			firetouchinterest(LocalPlayer.Character.StandMorph.Propellers, v.HumanoidRootPart, 1)
			firetouchinterest(LocalPlayer.Character.StandMorph.Propellers, v.HumanoidRootPart, 0)
                        end
                        v:Destroy()
                    end
                end
